...
/**
 * An interpolator where the rate of change starts out fast and then decelerates
 * over time.
 * 
...
public class DecelerateInterpolator implements Interpolator {
	...
	/**
	 * Gets a new {@link DecelerateInterpolator} from a maintained pool of
	 * {@link Interpolator}s.
	 * 
	 * @param factor
	 *            the factor controlling the rate of change
	 ...
	 * <code>{@value DecelerateInterpolator#DEFAULT_FACTOR}</code>.
	 * 
	 * @return the obtained {@link DecelerateInterpolator}
	 */
