...
/**
 * An interpolator where the rate of change starts out slowly, grows over time
 * and ends slowly.
 * 
...
public class AccelerateDecelerateInterpolator implements Interpolator {
	...
	/**
	 * Gets a new {@link AccelerateDecelerateInterpolator} from a maintained
	 ...
	 * <code>{@value AccelerateDecelerateInterpolator#DEFAULT_FACTOR}</code>.
	 * 
	 * @return the obtained {@link AccelerateDecelerateInterpolator}
	 */
