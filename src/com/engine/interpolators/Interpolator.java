...
public interface Interpolator {
	...
	/**
	 * Maps a point in the animation duration to a multiplier to be applied to
	 * the transformations of an animation. The Input is a percentage of the
	 ...
	 *         {@link Interpolator}s which overshoot their targets, or less than
	 *         0 for {@link Interpolator}s that undershoot their targets.
	 */
	float getInterpolation(float input);

	/**
	 * Called when the animation has finished and the {@link Interpolator} is no
	 * longer needed.
	 */
	void finished();
