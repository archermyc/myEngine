...
/**
 * An {@link Interpolator} where the changes start backwards and than spring
 * forward as the time progresses.
 * 
...
public class AnticipateInterpolator implements Interpolator {
	...
	/**
	 * Gets a new {@link AnticipateInterpolator} from a maintained pool of
	 * {@link Interpolator}s.
	 * 
	 * @param tension
	 *            the tension controlling the rate spring effect of the
	 *            animation
	 * @return the obtained {@link AccelerateInterpolator}
	 */
	public static AnticipateInterpolator $(float tension) {
		AnticipateInterpolator inter = new AnticipateInterpolator();
	 ...
	 * <code>{@value AnticipateInterpolator#DEFAULT_TENSION}</code>.
	 * 
