...
/**
 * An interpolator where the change overshoots the target and springs back to
 * the target position.
 * <p>
...
public class OvershootInterpolator implements Interpolator {
	...
	/**
	 * Gets a new {@link OvershootInterpolator} from a maintained pool of
	 * {@link Interpolator}s.
	 * 
	 * @param factor
	 *            the factor controlling the rate of overshoot energy change
	 ...
	 * <code>{@value OvershootInterpolator#DEFAULT_FACTOR}</code>.
	 * 
	 * @return the obtained {@link OvershootInterpolator}
	 */
